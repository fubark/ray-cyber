...
func load():
    ...
    ffi.cfunc('WindowShouldClose', [], symbol.bool)
    ffi.cfunc('IsWindowReady', [], symbol.bool)
    ffi.cfunc('IsWindowFullscreen', [], symbol.bool)
    ffi.cfunc('IsWindowHidden', [], symbol.bool)
    ffi.cfunc('IsWindowMinimized', [], symbol.bool)
    ffi.cfunc('IsWindowMaximized', [], symbol.bool)
    ffi.cfunc('IsWindowFocused', [], symbol.bool)
    ffi.cfunc('IsWindowResized', [], symbol.bool)
    ...
    ffi.cfunc('ToggleFullscreen', [], symbol.void)
    ffi.cfunc('ToggleBorderlessWindowed', [], symbol.void)
    ffi.cfunc('MaximizeWindow', [], symbol.void)
    ffi.cfunc('MinimizeWindow', [], symbol.void)
    ffi.cfunc('RestoreWindow', [], symbol.void)
    ...
    ffi.cfunc('SetWindowFocused', [], symbol.void)
    ffi.cfunc('GetWindowHandle', [], symbol.voidPtr)
    ffi.cfunc('GetScreenWidth', [], symbol.int)
    ffi.cfunc('GetScreenHeight', [], symbol.int)
    ffi.cfunc('GetRenderWidth', [], symbol.int)
    ffi.cfunc('GetRenderHeight', [], symbol.int)
    ffi.cfunc('GetMonitorCount', [], symbol.int)
    ffi.cfunc('GetCurrentMonitor', [], symbol.int)
    ...
    ffi.cfunc('GetClipboardText', [], symbol.voidPtr)
    ffi.cfunc('EnableEventWaiting', [], symbol.void)
    ffi.cfunc('DisableEventWaiting', [], symbol.void)
    ffi.cfunc('ShowCursor', [], symbol.void)
    ffi.cfunc('HideCursor', [], symbol.void)
    ffi.cfunc('IsCursorHidden', [], symbol.bool)
    ffi.cfunc('EnableCursor', [], symbol.void)
    ffi.cfunc('DisableCursor', [], symbol.void)
    ffi.cfunc('IsCursorOnScreen', [], symbol.bool)
    ffi.cfunc('ClearBackground', [Color], symbol.void)
    ffi.cfunc('BeginDrawing', [], symbol.void)
    ffi.cfunc('EndDrawing', [], symbol.void)
    ffi.cfunc('BeginMode2D', [Camera2D], symbol.void)
    ffi.cfunc('EndMode2D', [], symbol.void)
    ffi.cfunc('BeginMode3D', [Camera3D], symbol.void)
    ffi.cfunc('EndMode3D', [], symbol.void)
    ffi.cfunc('BeginTextureMode', [RenderTexture2D], symbol.void)
    ffi.cfunc('EndTextureMode', [], symbol.void)
    ffi.cfunc('BeginShaderMode', [Shader], symbol.void)
    ffi.cfunc('EndShaderMode', [], symbol.void)
    ffi.cfunc('BeginBlendMode', [symbol.int], symbol.void)
    ffi.cfunc('EndBlendMode', [], symbol.void)
    ffi.cfunc('BeginScissorMode', [symbol.int, symbol.int, symbol.int, symbol.int], symbol.void)
    ffi.cfunc('EndScissorMode', [], symbol.void)
    ffi.cfunc('BeginVrStereoMode', [VrStereoConfig], symbol.void)
    ffi.cfunc('EndVrStereoMode', [], symbol.void)
    ...
    ffi.cfunc('GetFrameTime', [], symbol.float)
    ffi.cfunc('GetTime', [], symbol.double)
    ffi.cfunc('GetFPS', [], symbol.int)
    ffi.cfunc('SwapScreenBuffer', [], symbol.void)
    ffi.cfunc('PollInputEvents', [], symbol.void)
    ...
    ffi.cfunc('GetWorkingDirectory', [], symbol.voidPtr)
    ffi.cfunc('GetApplicationDirectory', [], symbol.voidPtr)
    ...
    ffi.cfunc('IsFileDropped', [], symbol.bool)
    ...
    ffi.cfunc('StartAutomationEventRecording', [], symbol.void)
    ffi.cfunc('StopAutomationEventRecording', [], symbol.void)
    ...
    ffi.cfunc('GetKeyPressed', [], symbol.int)
    ffi.cfunc('GetCharPressed', [], symbol.int)
    ...
    ffi.cfunc('GetGamepadButtonPressed', [], symbol.int)
    ...
    ffi.cfunc('GetMouseX', [], symbol.int)
    ffi.cfunc('GetMouseY', [], symbol.int)
    ...
    ffi.cfunc('InitAudioDevice', [], symbol.void)
    ffi.cfunc('CloseAudioDevice', [], symbol.void)
    ffi.cfunc('IsAudioDeviceReady', [], symbol.bool)
    ffi.cfunc('SetMasterVolume', [symbol.float], symbol.void)
    ffi.cfunc('GetMasterVolume', [], symbol.float)
